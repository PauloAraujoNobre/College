...
plot_grafico(x, tempo_ord, tempo_des, "GraficoTempo.png", "Tempo Embaralhado", "Tempo Invertido")
plot_grafico(x, count_ord, count_des, "GraficoInteracoes.png", "Numero de Interacoes Embaralhado", "Numero de Interacoes Invertido")
